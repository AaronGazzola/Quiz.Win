  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="focus-ring data-[state=open]:bg-secondary absolute top-4 right-4 radius opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none">
